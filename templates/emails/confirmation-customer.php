...
<body>
    <div class="email-wrap">
        ...
        <div class="email-body">
            ...
            <p><?php esc_html_e('Your booking is confirmed and payment received. Here are your details:', 'space-booking'); ?>
            </p>
            ...
            <table class="email-table">
                ...
                <tr>
                    ...
                    <td><?php echo esc_html(substr($booking['start_time'], 0, 5) . ' – ' . substr($booking['end_time'], 0, 5)); ?>
                    </td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Duration', 'space-booking'); ?></th>
                    <td><?php echo esc_html($booking['duration_hours']); ?>h</td>
                </tr>
                <?php if (!empty($extras)): ?>
                <tr>
                    <th><?php esc_html_e('Extras', 'space-booking'); ?></th>
                    <td><?php echo esc_html(implode(', ', array_column($extras, 'extra_name'))); ?></td>
                </tr>
                <?php endif; ?>
                <?php if ($booking['notes']): ?>
                <tr>
                    <th><?php esc_html_e('Notes', 'space-booking'); ?></th>
                    <td><?php echo esc_html($booking['notes']); ?></td>
                </tr>
                <?php endif; ?>
                <tr>
                    <th><?php esc_html_e('Access Instructions', 'space-booking'); ?></th>
                    <td><?php echo esc_html(get_post_meta((int) $booking['space_id'], '_sb_access_instructions', true) ?: __('Check with venue staff on arrival.', 'space-booking')); ?>
                    </td>
                </tr>
                <tr class="total-row">
                    <th><?php esc_html_e('Total Paid', 'space-booking'); ?></th>
                    <td><?php echo \SpaceBooking\Services\CurrencyService::format((float) $booking['total_price']); ?>
                    </td>
                </tr>
        ...
        <div class="email-footer">
            <p><?php printf(esc_html__('© %s %s. All rights reserved.', 'space-booking'), date('Y'), esc_html($site_name)); ?>
            </p>
        </div>
    </div>
</body>
